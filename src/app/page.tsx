    ...
    <section className='flex items-center justify-center gap-20 p-5'>
      <FadeIn>
        <div className='md:space-y-10 space-y-8 relative z-10'>
          <header>
            <p className='text-muted-foreground text-lg font-extralight'>Hola Folks 👋 , I am </p>
            <AnimatedName />
          ...
          <div className='space-y-2 sm:text-sm text-xs'>
            ...
            <p className='text-muted-foreground'>
              ...
              <a target='_blank' href='https://github.com/radhika0910/Radhika-s-site' className='text-light-brown hover:underline hover:text-foreground transition-colors'>
                &apos;https://github.com/radhika0910/Radhika-s-site&apos;
              </a>
            </p>
          </div>
        </div>
