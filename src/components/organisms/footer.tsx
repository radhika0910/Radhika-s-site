  ...
  return (
    <footer className='border-t text-off-white text-xs flex items-center justify-between select-none bg-layout relative z-30'>
      <div className='flex items-center border-r divide-x'>
        <Link
          target='_blank'
          href='https://github.com/radhika0910/Radhika-s-site'
      ...
      <div className='flex items-center divide-x divide border-l'>
        ...
        <Link target='_blank' href='https://github.com/radhika0910' className='flex items-center gap-x-1 px-2 py-1 hover:text-foreground text-muted-foreground transition-colors'>
          <p>CodeRadds</p>
